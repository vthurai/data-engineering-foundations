...
# Simply put, doing this will allow Python to read your pattern literally and avoid some
# potential problems when processing special characters.
...
# Similar to replace(), sub returns a string with all matches substituted with the replacement.
...
# Special characters used inside [] will be matched literally.
...
# The '^' symbol means to match any character not listed inside the [].
print("Example #12:", re.findall(r"[^cb]at", "mat cat bat car date Saturday"))

# ()
# Signifies a capture group. Forms a pattern unit which can be used in conjunction with other rules.
# If used with findall, findall will instead return a list of tuples containing the matching groups.
print("Example #13:", re.sub(r"(cat|dog){2}", "mouse", "cat dog catcatcat dogcatdog dogdogcatcat"))
print("Example #14:", re.findall(r"(c.{3}) and (d.{3})", "There are many cats and dogs. There are many cars and dots."))

# \d and \D
# Matches any digit or non-digit. Equivalent to [0-9] (or [^0-9]).
print("Example #15:", re.findall(r"\d", "There are 16 dogs."))
print("Example #16:", re.findall(r"\D+", "There are 16 dogs."))

# \w and \W
# Matches any word or non-word character (letter, digit, or underscore).
# Equivalent to [a-zA-Z0-9_] (or [^a-zA-Z0-9_]).
print("Example #17:", re.findall(r"\w+", "Hello there."))
print("Example #18:", re.findall(r"\W", "Hello there."))

# \n
# Matches the newline character.
print("Example #19:", re.findall(r"\w+\n", "Roses are red\nViolets are blue\nYou better watch out\nI'm coming for you!"))

# \s and \S
# Matches any whitespace or non-whitespace character (space, tab, or newline).
print("Example #20:", re.findall(r"[a-zA-Z.']+\s", "Knock knock.\nWho's there?"))
print("Example #21:", re.findall(r"\S+", "Knock knock.\nWho's there?"))

# \
# Known as the escape character.
# Matches the next character literally as long as it is not part of any sequence mentioned above.
print("Example #22:", re.findall(r"\[\w+\]", "There are [seventy] dogs."))
